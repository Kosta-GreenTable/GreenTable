...
<html lang="ko">
  <head>
    ...
    <meta name="category" content="샐러드" />
    ...
    <link
      rel="stylesheet"
      href="${pageContext.request.contextPath}/css/salad.css"
    />
    <link
      rel="stylesheet"
    ...
    <main class="product-page">
      ...
      <div class="pagination">
        <div class="pagination-prev">
          <c:if test="${pageNo > 1}">
            <a
              href="${pageContext.request.contextPath}/front?key=product&methodName=category&category=salad&pageNo=${pageNo - 1}"
            >
        ...
        <ul class="pagination-list">
          <c:forEach begin="1" end="${totalPages}" var="i">
            <li class="pagination-item ${i == pageNo ? 'active' : ''}">
              <a
                href="${pageContext.request.contextPath}/front?key=product&methodName=category&category=salad&pageNo=${i}"
              >
                <button>${i}</button>
              </a>
            </li>
