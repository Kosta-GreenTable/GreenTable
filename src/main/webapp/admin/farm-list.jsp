        ...
        <aside class="admin-sidebar">
            ...
            <nav class="admin-nav">
                <ul>
                    ...
                    <li class="active"><a href="${pageContext.request.contextPath}/front?key=farm&methodName=adminList"><i class="fas fa-tractor"></i> 농가 관리</a></li>
        ...
        <main class="admin-content">
            <header class="admin-header">
                ...
                <div class="admin-user">
                    ...
                    <button class="btn-danger" onclick="location.href='${pageContext.request.contextPath}/front?key=user&methodName=logout'">
