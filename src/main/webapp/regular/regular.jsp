...
<html lang="ko">
  <head>
    ...
    <meta name="category" content="정기배송" />
    <title>정기배송 상품 | Green Table</title>
    <link
      rel="stylesheet"
    ...
    <link
      rel="stylesheet"
      href="${pageContext.request.contextPath}/css/regular.css"
    />
    <link
      rel="stylesheet"
  ...
  <body>
    ...
    <main class="product-page">
      ...
      <div class="category-banner">
        <img
          src="${pageContext.request.contextPath}/products/images/regular-banner.jpg"
          alt="정기배송 상품"
        />
      </div>
      ...
      <div class="pagination">
        <div class="pagination-prev">
          <c:if test="${pageNo > 1}">
            <a
              href="${pageContext.request.contextPath}/front?key=product&methodName=category&category=regular&pageNo=${pageNo - 1}"
            >
        ...
        <ul class="pagination-list">
          <c:forEach begin="1" end="${totalPages}" var="i">
            <li class="pagination-item ${i == pageNo ? 'active' : ''}">
              <a
                href="${pageContext.request.contextPath}/front?key=product&methodName=category&category=regular&pageNo=${i}"
              >
                <button>${i}</button>
              </a>
            </li>
    ...
    <script src="${pageContext.request.contextPath}/js/regular.js"></script>
  </body>
</html>
