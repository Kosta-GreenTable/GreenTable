...
<html lang="ko">
    ...
    <body>
        ...
        <div id="header-container"><jsp:include page="/include/header.html"/></div>
        ...
        <main class="login-container">
            <div class="login-wrapper">
                ...
                <div class="tab-content active" id="member-tab">
                    <form class="login-form" id="member-login-form">
                        ...
                        <div class="login-options">
                            ...
                            <div class="login-links">
                                ...
                                <a href="${path}/front?key=user&methodName=join" id="register">회원가입</a>
                            </div>
                        </div>
        ...
        <div id="footer-container"><jsp:include page="/include/footer.html"/></div>
        ...
        <script src="${path}/js/include.js"></script>
