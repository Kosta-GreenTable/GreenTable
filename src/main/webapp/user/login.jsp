    ...
    <main class="login-container">
      <div class="login-wrapper">
        ...
        <div class="login-tabs">
          <button class="tab-btn active" data-tab="member">회원 로그인</button>
          <button class="tab-btn" data-tab="non-member">비회원 주문조회</button>
        </div>
        ...
        <div class="tab-content active" id="member-tab">
          <form
            ...
            action="${path}/front?key=user&methodName=login"
            method="POST"
          >
            ...
            <div class="login-options">
              ...
              <div class="login-links">
                <a href="#" id="find-id-pw">아이디/비밀번호 찾기</a>
                <span class="divider">|</span>
                <a
                  href="${path}/front?key=user&methodName=register"
                  id="register"
                  >회원가입</a
                >
              </div>
        ...
        <div class="tab-content" id="non-member-tab">
          <form
            class="login-form"
            id="non-member-login-form"
            action="${path}/front?key=order&methodName=getGuestOrder"
            method="POST"
          >
            <!-- <div class="input-group">
            ...
            <button type="submit" class="login-btn">주문 조회하기</button>
          </form>
          <div class="non-member-info">
            <p>
              <i class="fas fa-info-circle"></i>
              비회원으로 주문하신 경우, 주문 시 입력하신 정보로 주문 조회가
              가능합니다.
            </p>
          </div>
        </div>
    ...
    <div class="modal" id="find-modal">
      <div class="modal-content">
        ...
        <div class="modal-tabs">
          ...
          <button class="modal-tab" data-tab="find-pw">비밀번호 찾기</button>
        </div>
              ...
              <div class="input-group">
                ...
                <div class="verify-input">
                  <input
                    ...
                    required
                  />
                  <button type="button" class="verify-btn">인증확인</button>
                </div>
