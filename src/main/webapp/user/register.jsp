        ...
        <div class="register-form-container">
          <form id="register-form" method="post">
            <div class="form-group">
              <label for="email"
                >이메일 (아이디)<span class="required">*</span></label
              >
              ...
              <p class="form-help" id="email-help">
                ※ 이메일 형식으로 입력해주세요. (예: example@greentable.com)
              </p>
              <p class="success-message hidden" id="duplicate-success">
                ✓ 사용 가능한 이메일입니다.
              </p>
              <p class="error-message hidden" id="duplicate-error">
                ✗ 이미 사용중인 이메일입니다.
              </p>
            </div>
            ...
            <div class="form-group hidden" id="email-verification-group">
              <label for="email-verification"
                >이메일 인증<span class="required">*</span></label
              >
              <div class="input-with-button">
                <button
                  type="button"
              ...
              <p class="form-help">
                ※ 위에서 중복확인을 완료한 후 이메일 인증을 진행해주세요.
              </p>
            </div>

            <div class="form-group hidden" id="verification-code-group">
              <label for="verification-code"
                >인증번호 입력<span class="required">*</span></label
              >
              <div class="input-with-button">
                <input
                  type="text"
              ...
              <p class="success-message hidden" id="verification-success">
                ✓ 이메일 인증이 완료되었습니다.
              </p>
              <p class="error-message hidden" id="verification-error">
                ✗ 인증번호가 일치하지 않습니다.
              </p>
            </div>
            ...
            <div class="form-group">
              ...
              />
              <p class="form-help">
                ※ 영문 대/소문자, 숫자, 특수문자 중 2가지 이상 조합하여
                10~16자리로 입력해주세요.
              </p>
            </div>
            ...
            <div class="form-group">
              <label for="mobile"
                >휴대전화<span class="required">*</span></label
              >
