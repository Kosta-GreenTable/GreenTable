...
<html lang="ko">
  <head>
    ...
    <meta name="category" content="도시락" />
    <title>도시락 상품 | Green Table</title>
    <link
      rel="stylesheet"
    ...
    <link
      rel="stylesheet"
      href="${pageContext.request.contextPath}/css/lunchbox.css"
    />
    <link
      rel="stylesheet"
  ...
  <body>
    ...
    <main class="product-page">
      ...
      <div class="category-banner">
        <img
          src="${pageContext.request.contextPath}/products/images/lunchbox-banner.jpg"
          alt="도시락 상품"
        />
      </div>
      ...
      <div class="pagination">
        <div class="pagination-prev">
          <c:if test="${pageNo > 1}">
            <a
              href="${pageContext.request.contextPath}/front?key=product&methodName=category&category=lunchbox&pageNo=${pageNo - 1}"
            >
        ...
        <ul class="pagination-list">
          <c:forEach begin="1" end="${totalPages}" var="i">
            <li class="pagination-item ${i == pageNo ? 'active' : ''}">
              <a
                href="${pageContext.request.contextPath}/front?key=product&methodName=category&category=lunchbox&pageNo=${i}"
              >
                <button>${i}</button>
              </a>
            </li>
    ...
    <script src="${pageContext.request.contextPath}/js/lunchbox.js"></script>
  </body>
</html>
